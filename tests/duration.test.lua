...
local constructor_cases = {
  ...
  { throws = 'bad duration key "M"'          , args = { { M           = 1 } } },
  { throws = 'bad duration key "d"'          , args = { { d           = 1 } } },
  { throws = 'bad duration key "day"'        , args = { { day         = 1 } } },
  { throws = 'bad duration key "epoch"'      , args = { { epoch       = 1 } } },
  { throws = 'bad duration key "fortnight"'  , args = { { fortnight   = 1 } } },
  { throws = 'bad duration key "h"'          , args = { { h           = 1 } } },
  { throws = 'bad duration key "hour"'       , args = { { hour        = 1 } } },
  { throws = 'bad duration key "isdst"'      , args = { { isdst       = 1 } } },
  { throws = 'bad duration key "m"'          , args = { { m           = 1 } } },
  { throws = 'bad duration key "millisecond"', args = { { millisecond = 1 } } },
  { throws = 'bad duration key "minute"'     , args = { { minute      = 1 } } },
  { throws = 'bad duration key "month"'      , args = { { month       = 1 } } },
  { throws = 'bad duration key "ms"'         , args = { { ms          = 1 } } },
  { throws = 'bad duration key "q"'          , args = { { q           = 1 } } },
  { throws = 'bad duration key "quarter"'    , args = { { quarter     = 1 } } },
  { throws = 'bad duration key "s"'          , args = { { s           = 1 } } },
  { throws = 'bad duration key "second"'     , args = { { second      = 1 } } },
  { throws = 'bad duration key "timestamp"'  , args = { { timestamp   = 1 } } },
  { throws = 'bad duration key "w"'          , args = { { w           = 1 } } },
  { throws = 'bad duration key "week"'       , args = { { week        = 1 } } },
  { throws = 'bad duration key "wday"'       , args = { { wday        = 1 } } },
  { throws = 'bad duration key "weekday"'    , args = { { weekday     = 1 } } },
  { throws = 'bad duration key "y"'          , args = { { y           = 1 } } },
  { throws = 'bad duration key "yday"'       , args = { { yday        = 1 } } },
  { throws = 'bad duration key "year"'       , args = { { year        = 1 } } },
}

local invalid_duration_cases = {
  { throws = 'bad duration key "M"'           , init = { { hours = 2 } }, args = { { M           = 1 } } },
  { throws = 'bad duration key "d"'           , init = { { hours = 2 } }, args = { { d           = 1 } } },
  { throws = 'bad duration key "day"'         , init = { { hours = 2 } }, args = { { day         = 1 } } },
  { throws = 'bad duration key "epoch"'       , init = { { hours = 2 } }, args = { { epoch       = 1 } } },
  { throws = 'bad duration key "fortnight"'   , init = { { hours = 2 } }, args = { { fortnight   = 1 } } },
  { throws = 'bad duration key "h"'           , init = { { hours = 2 } }, args = { { h           = 1 } } },
  { throws = 'bad duration key "hour"'        , init = { { hours = 2 } }, args = { { hour        = 1 } } },
  { throws = 'bad duration key "isdst"'       , init = { { hours = 2 } }, args = { { isdst       = 1 } } },
  { throws = 'bad duration key "m"'           , init = { { hours = 2 } }, args = { { m           = 1 } } },
  { throws = 'bad duration key "millisecond"' , init = { { hours = 2 } }, args = { { millisecond = 1 } } },
  { throws = 'bad duration key "minute"'      , init = { { hours = 2 } }, args = { { minute      = 1 } } },
  { throws = 'bad duration key "month"'       , init = { { hours = 2 } }, args = { { month       = 1 } } },
  { throws = 'bad duration key "ms"'          , init = { { hours = 2 } }, args = { { ms          = 1 } } },
  { throws = 'bad duration key "q"'           , init = { { hours = 2 } }, args = { { q           = 1 } } },
  { throws = 'bad duration key "quarter"'     , init = { { hours = 2 } }, args = { { quarter     = 1 } } },
  { throws = 'bad duration key "s"'           , init = { { hours = 2 } }, args = { { s           = 1 } } },
  { throws = 'bad duration key "second"'      , init = { { hours = 2 } }, args = { { second      = 1 } } },
  { throws = 'bad duration key "timestamp"'   , init = { { hours = 2 } }, args = { { timestamp   = 1 } } },
  { throws = 'bad duration key "w"'           , init = { { hours = 2 } }, args = { { w           = 1 } } },
  { throws = 'bad duration key "week"'        , init = { { hours = 2 } }, args = { { week        = 1 } } },
  { throws = 'bad duration key "wday"'        , init = { { hours = 2 } }, args = { { wday        = 1 } } },
  { throws = 'bad duration key "weekday"'     , init = { { hours = 2 } }, args = { { weekday     = 1 } } },
  { throws = 'bad duration key "y"'           , init = { { hours = 2 } }, args = { { y           = 1 } } },
  { throws = 'bad duration key "yday"'        , init = { { hours = 2 } }, args = { { yday        = 1 } } },
  { throws = 'bad duration key "year"'        , init = { { hours = 2 } }, args = { { year        = 1 } } },
}
-- stylua: ignore end

describe("mods.duration", function()
  it("stays available through mods.date.duration for compatibility", function()
    assert.are_equal(Duration, Date.duration)
  end)
